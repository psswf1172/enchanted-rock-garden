(function($){
	...
	$(document).ready(function() {
		...
		var mapLocation = new google.maps.LatLng(44.8861269, -93.2862030);
		...
		if ($mapis.length > 0) {
			...
			map.addMarker({
				...
				title: 'Rival',
				infoWindow: {
					content: '<p><strong>The Enchanted Rock Garden</strong><br/>6445 Lyndale Avenue South<br/>P: (612) 886-1140<br/>United States</p>'
				}
			});
